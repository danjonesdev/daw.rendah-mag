  ...
  if (data.length) {
    return (
      <Div100vh>
        ...
        <div className="device-orientation-message  align-center  justify-center  bg-black  w-100">
          <div className="flex  flex-wrap  align-center  justify-center  ph4">
            ...
            />
            <p className="white  f3  bold  tac  w-100">Welcome to</p>
            <p className="white  f2  bold  tac  mb2  w-100">Rendah Mag DAW</p>
            <p className="white  f4  tac  mb5  w-100">
